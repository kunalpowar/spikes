...
var pins = gpio.PinMap{
	...
	&gpio.PinDesc{4, []string{"P9_33", "AIN4"}, gpio.AIN},
	&gpio.PinDesc{6, []string{"P9_35", "AIN6"}, gpio.AIN},
	&gpio.PinDesc{5, []string{"P9_36", "AIN5"}, gpio.AIN},
	&gpio.PinDesc{2, []string{"P9_37", "AIN2"}, gpio.AIN},
	&gpio.PinDesc{3, []string{"P9_38", "AIN3"}, gpio.AIN},
	&gpio.PinDesc{0, []string{"P9_39", "AIN0"}, gpio.AIN},
	&gpio.PinDesc{1, []string{"P9_40", "AIN1"}, gpio.AIN},
}
